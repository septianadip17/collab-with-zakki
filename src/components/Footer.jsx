        ...
        <div className="flex flex-wrap justify-between">
          <div className="w-full md:w-1/4 mb-6 md:mb-0">
            ...
            <p className="mb-4">
              ...
              Duri, Tebet, South Jakarta - Indonesia. Indonesia 12840
            </p>
            <p className="mb-4">
              <i className="fas fa-phone-alt"></i> (+6221) 21383994
            </p>
            <button className="bg-white text-green-700 py-2 px-4 rounded-full">
              <i className="fas fa-map-marker-alt"></i> Petunjuk Arah
            </button>
          </div>
          <div className="w-full md:w-1/5 mb-6 md:mb-0">
            ...
            <ul>
              <li className="mb-2">
                <a href="#">Tentang Ecodoe</a>
              </li>
              <li className="mb-2">
                <a href="#">Kreator UMKM</a>
              </li>
              <li className="mb-2">
                <a href="#">Portofolio</a>
              </li>
        ...
        <div className="mt-10 text-center">
          ...
          <div className="flex justify-center">
            <input
              ...
              className="p-2 rounded-l-full text-gray-700"
            />
            <button className="bg-white text-green-700 py-2 px-4 rounded-r-full">
              Langganan
            </button>
          </div>
        </div>
